"""
Django settings for Makaleaiweb project.
...
SECRET_KEY = 'django-insecure-1m^2p3a1l-(4--b_69s!w0+jbbt@j-o46jz^5y8)v+-9f0n#lq'
...
WSGI_APPLICATION = 'Makaleaiweb.wsgi.application'
